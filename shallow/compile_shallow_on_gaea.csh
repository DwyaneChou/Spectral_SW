...
set template  = $cwd/../bin/mkmf.template.$platform     # path to template for your platform. Changed the template back to what I used for SCM
...
#--------------------------------------------------------------------------------------------------------
set execdir = $cwd/exec.$platform.without.bronx  # where code is compiled and executable is created
